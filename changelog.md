...
5.6. Добавлена админка.  
ToDo Защитить админку с помощью AuthGuard  
ToDo Подгружать динамически, если у пользователя есть право работать как админ (canActivateGuard).
